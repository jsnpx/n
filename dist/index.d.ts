...
const normalizeUrl = async (nurl, encoding = "utf-8") => {
  let output;
  try {
...
const normalizePath = async (pth, encoding = "utf-8") => {
  let output;
  try {
...
export { normalize, normalizePath, normalizeUrl };
